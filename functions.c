	...
	int flags, int width, int precision, int size)
{
	...
	return (writehandle1(c, buffer, flags, width, precision, size));
}
	...
	int flags, int width, int precision, int size)
{
	...
	return (unsgndhandl(0, i, buffer, flags, width, precision, size));
}
	...
	int flags, int width, int precision, int size)
{
	...
	return (handlnumbers(is_negative, i, buffer, flags, width, precision, size));
}
...
/**
 * unprintable - Prints ascii codes in hexa of non printable chars
 */
	...
	int flags, int width, int precision, int size)
{
	...
	return (pointerhandl(buffer, ind, length,
